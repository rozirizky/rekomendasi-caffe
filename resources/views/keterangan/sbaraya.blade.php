		...
		<!-- End Header/Navigation -->
			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="col-lg-6">
						<h2 class="section-title">Starbuck Araya</h2>
						<p> Cafe yang sangat di gemari oleh semua kalangan dan tepat berada di halaman mall Plaza Araya, memiliki tempat yang aesthatic.</p>
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>Alamat</h3>
									<p> Area luar halaman Plaza Araya Jl. Raya Blimbing Indah, Polowijen, Kec. Blimbing, Kota Malang, Jawa Timur 65126</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									...
									<p> Untuk menu food and drink  berkisar antara <br>Rp 30.000 – Rp 60.000 ke atas</p>
								</div>
							</div>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="images/blog-2.png" alt="Image" class="img-fluid">
						</div>
					</div>
