		...
		<!-- End Header/Navigation -->
			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="col-lg-6">
						<h2 class="section-title">Noi Coffe</h2>
						<p>Merupakan salah satu coffee shop populer di kalangan wisatawan yang berkunjung di Batu khususnya kawasan Cangar dan menyediakan tempat duduk outdoor hingga indoor.</p>

						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="images/route1.png" alt="Image" class="imf-flu">
									</div>
									<h3>Alamat</h3>
									<p> Jl. Raya Sumber Brantas No.310, Sumber Brantas, Kec. Bumiaji, Kota Batu, Jawa Timur 65336</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									<div class="icon">
										<img src="images/food.png" alt="Image" class="imf-fluid">
									</div>
									<h3>Food and Drink</h3>
									<p> Untuk menu food and drink nya sangat terjangkau mulai dari Rp 7.000 - Rp 26.000</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									<div class="icon">
										<img src="images/clock.png" alt="Image" class="imf-fluid">
									</div>
									<h3>Jam Buka</h3>
									<p> Setiap Hari    10.00 - 19.00 WIB</p>
								</div>
							</div>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="images/blog-8.png" alt="Image" class="img-fluid">
						</div>
					</div>
