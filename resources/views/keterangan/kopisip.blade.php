		...
		<!-- End Header/Navigation -->
			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="col-lg-6">
						<h2 class="section-title">Kopi Sipp Pandanwangi Sulfat</h2>
						<p> Spot nongkrong asik dan kekinian dengan tema outdor, tapi tenang aja ada indornya juga kok.</p>
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>Alamat</h3>
									<p>  Ruko Green Sulfat, Jl. Simpang L.A. Sucipto Kav 16, Pandanwangi, Kec. Blimbing, Kota Malang, Jawa Timur 65126</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									...
									<p> Untuk menu food and drink nya sangat terjangkau mulai dari Rp 10.000 - Rp 20.000</p>
								</div>
							</div>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="images/blog-6.png" alt="Image" class="img-fluid">
						</div>
					</div>
