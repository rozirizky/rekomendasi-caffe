		...
		<!-- End Header/Navigation -->
			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="col-lg-6">
						<h2 class="section-title">Lafayette</h2>
						<p> Memiliki daya tarik tempat nongkrong yang sangat aesthatic apalagi dibagian outdor lantai atas.</p>
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>Alamat</h3>
									<p> Jl. Semeru No.2, RW.4, Oro-oro Dowo, Kec. Klojen, Kota Malang, Jawa Timur 65119</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									...
									<p> Untuk menu food and drink nya sangat terjangkau mulai dari Rp 10.000 - Rp 45.000</p>
								</div>
							</div>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="images/blog-4.png" alt="Image" class="img-fluid">
						</div>
					</div>
