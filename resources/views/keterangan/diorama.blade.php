		...
		<!-- End Header/Navigation -->
			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="col-lg-6">
						<h2 class="section-title">CR / Critasena</h2>
						<p> Memiliki daya tarik tempat nongkrong baru yang nyaman dengan design menarik industrial yang memiliki banyak spot instagramable bernuansa syahdu.</p>
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>Alamat</h3>
									<p> Jl. Kahuripan No.1, Klojen, Kec. Klojen, Kota Malang, Jawa Timur 65119</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									...
									<h3>Jam Buka</h3>
									<p> Setiap Hari    11.00 - 02.00 WIB</p>
								</div>
							</div>
