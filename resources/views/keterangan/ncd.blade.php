		...
		<!-- End Header/Navigation -->
			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="col-lg-6">
						<h2 class="section-title">Nakoa Cafe Dinoyo</h2>
						<p> Nakoa Cafe merupakan tempat nongkrong yang cocok untuk generasi milenial yang memadukan beberapa konsep, mulai dari vintage hingga tema kartun.</p>
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>Alamat</h3>
									<p> Jl. MT. Haryono No.116, Ketawanggede, Kec. Lowokwaru, Kota Malang, Jawa Timur</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									...
									<p> Untuk menu food and drink nya sangat ramah di kantong mulai dari Rp 15.000 - Rp 27.000</p>
								</div>
							</div>
							...
							<div class="col-7 col-md-7">
								<div class="feature">
									...
									<h3>Jam Buka</h3>
									<p> Setiap Hari    09.00 - 00.00 WIB</p>
								</div>
							</div>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="images/blog-3.png" alt="Image" class="img-fluid">
						</div>
					</div>
